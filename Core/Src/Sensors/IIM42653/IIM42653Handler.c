...
//    }
    ...
    if (IIM42653_SetGyroConfig(IIM42653_Handle, IIM42653_REG_GYRO_CONFIG0_GYRO_ODR_HZ_200, IIM42653_REG_GYRO_CONFIG0_GYRO_UI_FS_SEL_DPS_2000) != HAL_OK) {
        return HAL_ERROR;
    }
    ...
    // TODO: 500Hz, DONE
    if (IIM42653_SetAccelConfig(IIM42653_Handle, IIM42653_REG_ACCEL_CONFIG0_ACCEL_ODR_HZ_200, IIM42653_REG_ACCEL_CONFIG0_ACCEL_UI_FS_SEL_G_32) != HAL_OK) {
        return HAL_ERROR;
    }
